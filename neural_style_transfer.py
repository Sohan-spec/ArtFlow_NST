...
if __name__ == "__main__":
    ...
    parser.add_argument("--content_img_name",type=str,help="choose any image from the data/content-images or feel free to add your own images there",default='lion.jpg')
    ...
    parser.add_argument("--saving_freq",type=int,help="how often your images get saved (cycles), choose -1 for only saving the last output image",default=100)
